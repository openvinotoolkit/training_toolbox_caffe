...
def python_net_file():
    with tempfile.NamedTemporaryFile(mode='w+', delete=False) as f:
        f.write("""name: 'glob_push_loss_layer_test_net'
                   force_backward: true
                   ...
                   layer { name: "anchor2" type: "Input" top: "anchor2"
                           input_param { shape { dim: 2 dim: 5 dim: 3 dim: 4 } } }
                   layer { type: 'Python' name: 'glob_push_loss' bottom: 'detections' bottom: 'centers'
                           bottom: 'anchor1' bottom: 'anchor2' top: 'glob_push_loss_value'
                           python_param { module: 'caffe.custom_layers.glob_push_loss_layer'
                                          layer: 'GlobPushLossLayer'
...
class TestGlobPushLossLayer(unittest.TestCase):
    def setUp(self):
    ...
    def test_forward(self):
        ...
        for i in xrange(2):
            ...
            for j in xrange(2):
                ...
                for k in xrange(2):
                    ...
                    out_mask = (losses > 0.0) * invalid_mask
                    local_loss_values = np.append(local_loss_values, losses[out_mask].reshape([-1]))
        ...
        predicted_loss_value = net_outputs['glob_push_loss_value']
