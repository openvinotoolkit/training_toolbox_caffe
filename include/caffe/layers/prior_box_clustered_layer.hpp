#ifndef CAFFE_PRIORBOX_CLUSTERED_LAYER_HPP_
#define CAFFE_PRIORBOX_CLUSTERED_LAYER_HPP_
...
class PriorBoxClusteredLayer : public Layer<Dtype> {
 public:
  /**
   * @param param provides PriorBoxParameter prior_box_param,
   *     with PriorBox options:
   ...
   */
  explicit PriorBoxClusteredLayer(const LayerParameter& param)
      : Layer<Dtype>(param) {}
  ...
  virtual inline const char* type() const { return "PriorBoxClustered"; }
...
#endif  // CAFFE_PRIORBOX_CLUSTERED_LAYER_HPP_
